---
title: "Annualized Asthma Exacerbation Rate (AAER)"
type: concept
status: learned
...
**AAER** = the number of **asthma exacerbations（哮喘急性加重）** per patient per year — the standard **primary efficacy endpoint** in asthma trials, especially biologics in severe asthma.

- **Exacerbation** = a protocol-defined worsening requiring **systemic / oral corticosteroids（全身/口服糖皮质激素）** (typically ≥3 days), or an emergency-department visit / hospitalization.
